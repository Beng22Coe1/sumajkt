    ...
    <link href="../assets/css/sb-admin-2.min.css" rel="stylesheet">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <a class="sidebar-brand d-flex align-items-center justify-content-center" href="index.html">
                ...
                <div class="sidebar-brand-text mx-3">SumaJKT</div>
            </a>
            ...
            <li class="nav-item">
                <a class="nav-link collapsed" href="../admin/news.php">
                    <i class="fas fa-fw fa-wrench"></i>
                    <span>Habari na Matukio</span>
                </a>
            </li>
            ...
            <li class="nav-item">
                <a class="nav-link" href="../admin/vendors.php">
                    ...
                    <span>Washiriki</span></a>
            </li>

            <!-- Nav Item - Tables -->
            <li class="nav-item">
                <a class="nav-link" href="../admin/leadership.php">
